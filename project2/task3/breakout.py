...
# Hidden layer
W_h = tf.Variable(name='W_h', initial_value=tf.truncated_normal(shape=[ni, nh], stddev=0.1))
...
b_o = tf.Variable(name='b_o', initial_value=tf.truncated_normal(shape=[no], stddev=0.1))
